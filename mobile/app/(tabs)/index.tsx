...
const styles = StyleSheet.create({
  ...
  headerLabel:     { fontSize:TYPE.label.size, fontFamily:TYPE.family.bold, letterSpacing:TYPE.label.ls, textTransform:'uppercase', marginBottom:SPACE.sm },
  netWorth:        { fontSize:TYPE.hero.size, fontFamily:TYPE.family.bold, letterSpacing:TYPE.hero.ls, lineHeight:TYPE.hero.lh },
  changeRow:       { flexDirection:'row', alignItems:'center', gap:SPACE.sm, marginTop:SPACE.sm },
  changeBadge:     { borderRadius:RADIUS.xl, paddingHorizontal:10, paddingVertical:3 },
  changeBadgeText: { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
  changeSub:       { fontSize:TYPE.caption.size, fontFamily:TYPE.family.regular },
  sparklineWrap:   { paddingBottom:SPACE.xs, marginBottom:SPACE.md },
  cardsGrid:       { flexDirection:'row', flexWrap:'wrap', gap:10, paddingHorizontal:SPACE.lg, marginBottom:SPACE.md },
  card:            { width:'47.5%', borderRadius:RADIUS.lg, padding:14, paddingBottom:12 },
  cardLabel:       { fontSize:TYPE.label.size, fontFamily:TYPE.family.bold, textTransform:'uppercase', letterSpacing:TYPE.label.ls, marginBottom:SPACE.xs },
  cardValue:       { fontSize:TYPE.title.size, fontFamily:TYPE.family.bold, letterSpacing:TYPE.title.ls },
  cardSub:         { fontSize:TYPE.label.size, fontFamily:TYPE.family.regular, marginTop:2 },
  section:         { marginHorizontal:SPACE.lg, borderRadius:RADIUS.lg, padding:SPACE.lg, marginBottom:SPACE.md },
  sectionTitle:    { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold, letterSpacing:-0.2, marginBottom:14 },
  breakdownRow:    { flexDirection:'row', gap:SPACE.lg, alignItems:'center' },
  breakdownBars:   { flex:1, gap:SPACE.sm },
  barRow:          { gap:3 },
  barLabelRow:     { flexDirection:'row', justifyContent:'space-between', marginBottom:3 },
  barLabel:        { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.bold },
  barValue:        { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.bold },
  barDot:          { width:7, height:7, borderRadius:RADIUS.xs },
  barTrack:        { height:4, borderRadius:RADIUS.xs, overflow:'hidden' },
  barFill:         { height:'100%', borderRadius:RADIUS.xs },
  pricesLabel:     { fontSize:TYPE.label.size, fontFamily:TYPE.family.bold, letterSpacing:TYPE.label.ls, marginBottom:10 },
  pricesGrid:      { flexDirection:'row', flexWrap:'wrap' },
  priceCell:       { width:'50%', flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingVertical:SPACE.sm-2, borderBottomWidth:0.5, paddingHorizontal:2 },
  priceName:       { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.regular },
  priceVal:        { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
});
...
const s = StyleSheet.create({
  ...
  detailTitle:    { fontSize:TYPE.body.size+2, fontFamily:TYPE.family.bold, letterSpacing:-0.3 },
  detailSubtitle: { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.regular, marginTop:2 },
  detailClose:    { width:30, height:30, borderRadius:RADIUS.pill, alignItems:'center', justifyContent:'center' },

  // Period selector
  periodRow:      { flexDirection:'row', justifyContent:'center', gap:SPACE.sm, paddingVertical:SPACE.md, paddingHorizontal:SPACE.xl, borderBottomWidth:0.5 },
  periodBtn:      { borderRadius:RADIUS.xl, paddingHorizontal:14, paddingVertical:SPACE.sm-2 },
  periodBtnText:  { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.bold },

  // Stats
  statsRow:       { flexDirection:'row', paddingHorizontal:SPACE.xl, paddingVertical:14, borderBottomWidth:0.5 },
  statCell:       { flex:1, alignItems:'center' },
  statLabel:      { fontSize:TYPE.label.size, fontFamily:TYPE.family.regular, marginBottom:3 },
  statValue:      { fontSize:TYPE.caption.size+1, fontFamily:TYPE.family.bold },

  // Chart hint + tooltip
  chartHintLabel: { textAlign:'center', fontSize:TYPE.label.size, fontFamily:TYPE.family.regular, marginTop:SPACE.sm-2, paddingBottom:SPACE.xs },
  emptyChart:     { textAlign:'center', paddingVertical:40, fontSize:TYPE.caption.size+1, fontFamily:TYPE.family.regular },
  tooltip:        { position:'absolute', width:TOOLTIP_W, borderRadius:RADIUS.sm, borderWidth:0.5, paddingHorizontal:SPACE.md, paddingVertical:SPACE.sm-2 },
  tooltipDate:    { fontSize:TYPE.micro.size, fontFamily:TYPE.family.regular, marginBottom:2 },
  tooltipVal:     { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },

  // Min/max
  minMaxRow:      { flexDirection:'row', gap:SPACE.md, marginHorizontal:SPACE.xl, marginTop:14, borderTopWidth:0.5, paddingTop:14 },
  minMaxCell:     { flex:1, borderRadius:RADIUS.md, padding:SPACE.md, alignItems:'center' },
  minMaxLabel:    { fontSize:TYPE.label.size, fontFamily:TYPE.family.bold, textTransform:'uppercase', letterSpacing:0.5, marginBottom:SPACE.xs },
  minMaxVal:      { fontSize:TYPE.body.size, fontFamily:TYPE.family.bold },

  // Breakdown sheet
  bdHint:          { textAlign:'center', fontSize:TYPE.label.size, fontFamily:TYPE.family.regular, marginTop:SPACE.sm-2, marginBottom:SPACE.xs },
  bdSectionTitle:  { fontSize:TYPE.caption.size+1, fontFamily:TYPE.family.bold, marginBottom:SPACE.md, letterSpacing:-0.2 },
  bdAssetRow:      { flexDirection:'row', alignItems:'center', gap:SPACE.md, paddingVertical:11 },
  bdAssetIcon:     { width:36, height:36, borderRadius:RADIUS.sm, alignItems:'center', justifyContent:'center', flexShrink:0 },
  bdAssetInitial:  { fontSize:TYPE.caption.size+1, fontFamily:TYPE.family.bold },
  bdAssetName:     { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
  bdAssetSub:      { fontSize:TYPE.label.size, fontFamily:TYPE.family.regular, marginTop:2 },
  bdAssetVal:      { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
  bdBarTrack:      { width:64, height:3, borderRadius:3, overflow:'hidden' },
  bdBarFill:       { height:'100%', borderRadius:3 },
  bdAssetPct:      { fontSize:TYPE.micro.size, fontFamily:TYPE.family.regular },
  bdLegendRow:     { flexDirection:'row', alignItems:'center', gap:SPACE.md, paddingVertical:11 },
  bdDot:           { width:10, height:10, borderRadius:RADIUS.xs, flexShrink:0 },
  bdLegendName:    { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
  bdLegendPct:     { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.regular, marginRight:SPACE.sm },
  bdLegendVal:     { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold, minWidth:70, textAlign:'right' },

  // Log
  logTitle:       { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold, marginBottom:SPACE.md-2, marginTop:SPACE.sm },
  logRow:         { flexDirection:'row', justifyContent:'space-between', alignItems:'center', paddingVertical:10, borderBottomWidth:0.5 },
  logDate:        { fontSize:TYPE.micro.size+2, fontFamily:TYPE.family.regular },
  logRight:       { alignItems:'flex-end', gap:2 },
  logDelta:       { fontSize:TYPE.micro.size, fontFamily:TYPE.family.bold },
  logVal:         { fontSize:TYPE.caption.size, fontFamily:TYPE.family.bold },
});
